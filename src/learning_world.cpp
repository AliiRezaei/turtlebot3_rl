...
int main(int argc, char **argv) {
    ...
    float **collisions = rl.get_collisions("world");
    int n_obsatcles = 9; // 9 obsatcles in world
    int n_collisions = n_obsatcles * theta.n;
    ...
    // init node :
    ros::init(argc, argv, "main_world_node");
